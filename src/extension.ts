...
export function globLaunch(folder: WorkspaceFolder | undefined, dictionaryOfGlobPatterns: object, options: vscode.DebugSessionOptions | undefined) {
    ...
    for (let [globPattern, launchTaskName] of Object.entries(dictionaryOfGlobPatterns)) {
        ...
        if (matchExists) {
            ...
            vscode.debug.startDebugging(folder, launchTaskName, options);
            return;
        }
    }
